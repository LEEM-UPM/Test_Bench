...
% Vectores de datos
data = struct;
data.time1.v  = single(zeros(1,10000));
data.time10.v  = single(zeros(1,10000));
data.time100.v  = single(zeros(1,10000));
            ...
            if u.NumBytesAvailable > 1
                ...
                if identificador ~= 69
                    ...
                    switch identificador
                        case 116  % t
                            data.time1.v(data.time1.i) = valor;
                            data.time1.i = data.time1.i + 1;
                            data.time10.v(data.time10.i) = valor;
                            data.time10.i = data.time10.i + 1;
                            data.time100.v(data.time100.i) = valor;
                            data.time100.i = data.time100.i + 1;
                        case 117  % u
                            data.time10.v(data.time10.i) = valor;
                            data.time10.i = data.time10.i + 1;
                            data.time100.v(data.time100.i) = valor;
...
%         set(p12, 'XData',  data.time.v(1,1:(data.time.i-1)), 'Ydata', data.t_3.v(1,1:(data.t_3.i-1)));
        ...
        X1 = data.time100.v(1,1:(data.time100.i-1));
        Y1 = data.force.v(1,1:(data.force.i-1));
        X2 = data.time1.v(1,1:(data.time1.i-1));
        Y2 = data.pre.v(1,1:(data.pre.i-1));
        X3 = data.time1.v(1,1:(data.time1.i-1));
        Y3 = data.hum.v(1,1:(data.hum.i-1));
        X4 = data.time1.v(1,1:(data.time1.i-1));
        Y4 = data.t_1.v(1,1:(data.t_1.i-1));
        X5 = data.time10.v(1,1:(data.time10.i-1));
        Y5 = data.acc_x.v(1,1:(data.acc_x.i-1));
        X6 = data.time10.v(1,1:(data.time10.i-1));
        Y6 = data.acc_y.v(1,1:(data.acc_y.i-1));
        X7 = data.time10.v(1,1:(data.time10.i-1));
        Y7 = data.acc_z.v(1,1:(data.acc_z.i-1));
        X8 = data.time1.v(1,1:(data.time1.i-1));
        Y8 = data.t_2.v(1,1:(data.t_2.i-1));
        X9 = data.time10.v(1,1:(data.time10.i-1));
        Y9 = data.ang_x.v(1,1:(data.ang_x.i-1));
        X10 = data.time10.v(1,1:(data.time10.i-1));
        Y10 = data.ang_y.v(1,1:(data.ang_y.i-1));
        X11 = data.time10.v(1,1:(data.time10.i-1));
        Y11 = data.ang_z.v(1,1:(data.ang_z.i-1));
        X12 = data.time1.v(1,1:(data.time1.i-1));
